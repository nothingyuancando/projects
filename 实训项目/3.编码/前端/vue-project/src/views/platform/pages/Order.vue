  ...
  <div class="order-management">
    <el-card class="box-card">
      ...
      <div class="order-list-section">
        <el-table :data="orders" style="width: 100%">
          ...
          <el-table-column prop="customer_id" label="客户编号"></el-table-column>
          <el-table-column label="订单状态">
            <template #default="scope">
              {{ orderStatusMap[scope.row.order_states] }}
            </template>
          </el-table-column>
          ...
          <el-table-column label="操作">
            <template #default="scope">
              ...
              <el-button size="mini" type="success" @click="handleComplete(scope.row)" :disabled="scope.row.order_states !== 2">完成订单</el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
    ...
    <el-dialog :visible.sync="viewDialogVisible" title="订单详情">
      <el-descriptions :border="true" :column="1">
        ...
        <el-descriptions-item label="客户编号">{{ currentOrder?.customer_id }}</el-descriptions-item>
        <el-descriptions-item label="订单状态">{{ orderStatusMap[currentOrder?.order_states] }}</el-descriptions-item>
        <el-descriptions-item label="订单时间">{{ currentOrder?.order_time }}</el-descriptions-item>
...
import {getOrderList, acceptOrderRequest, rejectOrderRequest, completeOrderRequest} from '@/api/platform/order.js';
